  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <i style="font-size: 80px" class="fa fa-id-card-o" aria-hidden="true"><small style="font-size: 60px">
      ...
      <form method="post" action="../model/salvar_aluno.php">
        <div class="form-group">
          <label style="font-size: 20px" for="exampleInputEmail1">Nome*</label>
          <input style="width: 50%; font-size: 20px" type="text" class="form-control" name="nome" placeholder="Nome" required>
          
        </div>
         <div class="form-group">

          <label style="font-size: 20px" for="exampleInputEmail1">Matricula*</label>
          <input style="width: 50%; font-size: 20px" maxlength="10" type="text" class="form-control" name="matricula" placeholder="matricula" onkeypress="return onlynumber();" required>
          ...
          if ($s=='error') {
            echo '<p style="font-size :20px; color: red">
                  Já exite um aluno com essa matricula!
                <p>';
          }
        }
          ?>
      ...
      <script>
        function buscar_minicursos(){
          var curso = $('#curso').val();
          if(curso){
            var url = 'busca_t.php?curso='+curso;
        ...
        <label style="font-size: 20px" for="exampleInputEmail1">O curso que irá ser ministrado a aluna*</label><br>
          ...
          <select style="color: #000; width:300px; height: 30px; width: 50%; font-size: 17px;" name="id_turma" id="minicurso" class="form-text text-muted" required="" required>
        ...
        <label style="font-size: 20px" for="exampleInputEmail1">CPF*</label>
          <input style="width: 50%; font-size: 20px" type="text" maxlength="11" class="form-control" name="cpf" placeholder="CPF" id="cpf" onkeypress="return onlynumber();" required>
          <?php 
          if(isset($_GET['cpf'])){
            $s = $_GET['cpf'];
            if ($s=='error') {
            echo '
                  <p style="font-size :20px; color: red">CPF ja casdastrado</p>
                ';
            }
          }
          ?>
        ...
        <div class="form-group">
          ...
          <input style="width: 50%; font-size: 20px" type="email" class="form-control" name="email" placeholder="EX.: exemplo@exmple.com" >
        ...
        <div class="form-group">
          ...
          <input style="width: 50%; font-size: 20px" type="text" id="telefone" maxlength="15" class="form-control" name="telefone" placeholder="(DD) 00000-0000" >
          
        </div>
        <button style="width: 50% ; font-size: 20px" type="submit" onclick="return confirm('Deseja Salvar o Aluno')" class="btn btn-primary">Salvar</button>
      </form>
