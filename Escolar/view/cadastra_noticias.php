...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <form class="form-check-label" method="post" action="../model/salvar_noticias.php">
	   <p style="font-size: 40px;">Noticia</p>
       <textarea style="width: 100%; font-size: 20px" rows="10" cols="40" name="noticia" maxlength="800000" required=""></textarea>	
       <input style="float: right;" type="date" name="data" required=""><samp style="float: right; margin-right: 20px;font-size: 20px">Data da noticia  </samp>
       <br>
       <br>
       <br>
       <p style="font-size: 20px">Permição para ler a notica.</p>
       
       <input style="width: 20px; height: 20px;" type="checkbox" name="professor"/>
       <span style="font-size: 20px">Professores</span>
  	   <br>
       <input style="width: 20px; height: 20px;" type="checkbox" name="aluno"/>
       <span style="font-size: 20px">Alunos</span>
       <br>
       <samp>A noticia sera visualizada de acordo com a permissão</samp>

  		
  		<br>
  		<button onclick="confirm('Enviar noticia') " class="btn btn-primary" style="float: right; font-size: 20px; width: 10% ; margin-top: -20px">Lançar</button>
