...
<head>
  ...
  <title>Relatorio de Turma</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <?php  
        ...
        if ($s=='error') {
            echo '<div style="width: 70%; padding: 6px; font-size: 40px; margin-top: 10px" class="alert alert-danger" role="alert">
                 Erro! Não se Pode Apargar uma Turma Relacionado!
                </div>';
            ...
            echo '<div style="width: 70%; padding: 6px; font-size: 40px; margin-top: 10px" class="alert alert-success" role="alert">
                 O Turma de ID '.$s.' deletado com sucesso!
                </div>';
          }
      }
          if(isset($_GET['re'])){
            ...
            echo '<div style="width: 70%; padding: 6px; font-size: 20px; margin-top: 10px" class="alert alert-danger" role="alert">
                Error! Já exite um turma com esse nome nesse curso!
                </div>';
          }
          ?>
    ...
    include_once '../model/conn.php';
        ...
        $result = $conn -> query("SELECT id, nome, id_curso FROM turma");
          ...
          while($row = $result->fetch(PDO::FETCH_OBJ)){
                   ...
                   $row3 = $result3->fetch(PDO::FETCH_OBJ);
                    ...
                    echo  '<tr class="tr2">
                           ...
                           <td><h3 style="margin-left: 5px;"><a href="alterar_turma.php?id='.$row -> id.'"><button title="Alterar" style="font-size: 30px; margin-top: -15px" onclick="return confirm('."'Deseja Alterar a Disciplina? '".')" type="submit" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></h3></td>
                           <td><h3 style="margin-left: 5px;"><a href="../model/deletar_turma.php?id='.$row -> id.'"><button title="Excluir" style="font-size: 30px; margin-top: -15px" onclick="return confirm('."'Deseja deletar a Disciplina? '".')" type="submit" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></a></h3></td>
                        </tr>';
                        $cont++;
  ...
  ?>
    ...
    <?php 
    if($cont==0){
          echo '<p style="font-size: 30px">Nenhuma turma foi cadastrada!</p>';
        }
     ?>
    </section>
