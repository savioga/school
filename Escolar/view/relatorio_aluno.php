...
<head>
  ...
  <title>Relatorio de Aluno</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <section class="content">
        ...
        if(isset($_GET['resut'])){
          ...
          if($s=='error'){
            echo '<div style="width: 70%; padding: 6px; font-size: 40px; margin-top: 10px" class="alert alert-danger" role="alert">
                 Erro! Não pode apagar um aluno relacionado!
                </div>';
          ...
          if(isset($_GET['matri'])){
              ...
              echo '<p style="font-size :20px; color: red">
                    Já exite um aluno casatrado com essa matricula!<br>
                <p>';
          ...
          if(isset($_GET['cpf'])){
              ...
              echo '<p style="font-size :20px; color: red">
                    Já exite um aluno casatrado com essa cpf!<br>
                <p>';
    ...
    include_once '../model/conn.php';
        ...
        $result = $conn -> query("SELECT id, nome, matricula, id_curso, cpf, email, telefone, id_turma FROM aluno");
          ...
          while($row = $result->fetch(PDO::FETCH_OBJ)){
                   ...
                   $row4 = $result4->fetch(PDO::FETCH_OBJ);
                    ...
                    echo  '<tr class="tr2">
                           ...
                           <td><h3 style="margin-left: 5px;"><a href="alterar_aluno.php?id='.$row -> id.'"><button title="Alterar" style="font-size: 30px; margin-top: -15px" onclick="return confirm('."'Deseja Alterar o Aluno? '".')" type="submit" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></h3></td>
                           <td><h3 style="margin-left: 5px;"><a href="../model/deletar_aluno.php?id='.$row -> id.'"><button title="Excluir" style="font-size: 30px; margin-top: -15px" onclick="return confirm('."'Deseja deletar o Aluno? '".')" type="submit" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></a></h3></td>
                        </tr>';
                        $cont++;
          }
        }
  ...
  ?>
    ...
    <?php
    if($cont==0){
          echo '<p style="font-size: 30px">Nenhum aluno foi cadastrado!</p>';
        }
      ?>
      </section>
