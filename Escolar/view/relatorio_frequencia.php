...
<head>
  ...
  <title>Relatorio de Frequencias</title>
...
<div class="wrapper">
          ...
          while($row = $result->fetch(PDO::FETCH_OBJ)){
                   ...
                   $row7 = $result7->fetch(PDO::FETCH_OBJ);
                    ...
                    echo  '<tr class="tr2">
                           ...
                           <td><h3 style="margin-left:  110px";><p>'.$row -> falta .'</p></h3></td>
                           <td><h3 style="margin-left:  110px;"><p>'.$row -> presenca .'</p></h3></td>
  ...
  ?>
    ...
    <?php if($cont==0){
          echo '<p style="font-size: 30px">Nenhuma frequencia foi efetuada!</p>';
        } ?>
      </section>
