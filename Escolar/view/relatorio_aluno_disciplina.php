...
<head>
  ...
  <title>Relatorio de Aluno em uma Disciplina</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="font-size: 60px">
        Relatorio de Alunos em Disciplinas
   ...
   <section class="content">
      ...
      <?php  
        if(isset($_GET['resut'])){
          $s = $_GET['resut'];
            ...
            echo '<div style="width: 50%; padding: 6px; font-size: 40px; margin-top: 10px" class="alert alert-success" role="alert">
                 O aluno de ID '.$s.' deletado com sucesso!
                </div>';
          }
          if(isset($_GET['r'])){
          $s = $_GET['r'];
            ...
            echo '<div style="width: 50%; padding: 6px; font-size: 40px; margin-top: 10px" class="alert alert-success" role="alert">
                 O aluno de ID '.$s.' Alterado com sucesso!
                </div>';
          }?>
      ...
      <table style="">
            <tr class="tr1">
              ...
              <td><h2 style="margin-left: 80px;"><b>Turma</b></h2></td>
    ...
    include_once '../model/conn.php';
        ...
        $result = $conn -> query("SELECT id, id_curso, id_ministra, id_aluno, id_turma FROM frequencia");
        ...
        if ($result) {
          ...
          while($row = $result->fetch(PDO::FETCH_OBJ)){
                   ...
                   $row3 = $result3->fetch(PDO::FETCH_OBJ);
                    $result4 = $conn -> query("SELECT id, nome FROM turma WHERE id = '{$row-> id_turma}'");   
                   ...
                   $row7 = $result7->fetch(PDO::FETCH_OBJ);
                    ...
                    echo  '<tr class="tr2">
                           ...
                           <td><h3 style="margin-left:  80px;"><p>'.$row7 -> nome .'</p></h3></td>
                           
                           <td><h3 style="margin-left: 50px;"><a href="#"><button title="Alterar" style="font-size: 30px; margin-top: -15px" onclick="return confirm('."'Deseja Alterar o Aluno? '".')" type="submit" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></h3></td>
                           <td><h3 style="margin-left: 5px;"><a href="../model/deletar_aluno_disciplina.php?id='.$row -> id.'"><button title="Excluir" style="font-size: 30px; margin-top: -15px" onclick="return confirm('."'Deseja deletar o Aluno? '".')" type="submit" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></a></h3></td>
                        </tr>';
                        $cont++;
  ...
  ?>
    ...
    <?php if($cont==0){
          echo '<p style="font-size: 30px">Nenhuma Aluno cadastrado em uma disciplina!</p>';
        } ?>
      </section>
