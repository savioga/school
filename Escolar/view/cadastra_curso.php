...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <i style="font-size: 80px" class="fa fa-graduation-cap" aria-hidden="true"><small style="font-size: 60px">
        Cadastra Curso
      ...
      ?> 
        ...
        <script type="text/javascript">
          ...
          $('#button').click(function() {
              $(this).html('<img src="../dist/img/load.gif" />');
          });
        </script>    
      <form method="post" action="../model/salvar_curso.php">
        <div class="form-group">

          <label style="font-size: 20px" for="exampleInputEmail1">Nome Do Curso*</label>
          <input style="width: 50%; font-size: 20px" type="text" class="form-control" name="nome" placeholder="Curso" id="nome" required="">
          <div id="resposta"></div>
          ...
          <?php  
            ...
            if(isset($_GET['resu'])){
                  ...
                  if($s=='error'){
                    echo '</i><div>
                           <p style="color: red; font-size: 20px">O curso de Nome  Já cadastrado! </p>
                       </div>';
        ...
        <button style="width: 50% ; font-size: 20px" id="button" onclick="return confirm('Deseja Salvar o Curso')" class="btn btn-primary">Salvar</button>
      </form>
