  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <i style="font-size: 80px" class="fa fa-address-book-o" aria-hidden="true"><small style="font-size: 60px">
      ...
      <br>
       <?php  
        if(isset($_GET['res'])){
          $s = $_GET['res'];
          if($s=='sucesso'){
            echo '</i><div style="width: 50%;  padding: 6px;" class="alert alert-success" role="alert">
      ...
      <form method="post" action="../model/salvar_professor.php">
        <div class="form-group">
          <label style="font-size: 20px" for="exampleInputEmail1">Nome*</label>
          <input style="width: 50%; font-size: 20px" type="text" class="form-control" name="nome" placeholder="Nome">
          
        </div>
        <div class="form-group">

          <label style="font-size: 20px" for="exampleInputEmail1">CPF*</label>
          <input style="width: 50%; font-size: 20px" type="text" maxlength="11" class="form-control" name="cpf" placeholder="CPF" onkeypress="return onlynumber();">
          <?php 
          if(isset($_GET['cpf'])){
            $s = $_GET['cpf'];
            if ($s=='error') {
        ...
        <div class="form-group">
          ...
          <input style="width: 50%; font-size: 20px" type="text" class="form-control" name="formacao" placeholder="Formação">
        ...
        <button style="width: 50% ; font-size: 20px" type="submit" onclick="return confirm('Deseja Salvar o Professor')" class="btn btn-primary">Salvar</button>
      </form>
