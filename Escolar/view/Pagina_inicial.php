  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div style="margin-left: 20px; margin-right: 10px" class="row">
        <div class="">
          <div class="info-box">
            <span class="info-box-icon bg-aqua"><i class="fa fa-users" aria-hidden="true"></i></i></span>
             <?php  
             $professor=0;
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $professor;  ?></span>
            </div>
           <a style="float: right;" href="relatorio_professor.php"><button class="btn btn-primary">Ver detalhes</button></a>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        </div>
        ...
        <div class="">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php  echo $aluno?></span>
            </div>
             <a style="float: right;" href="relatorio_aluno.php"><button class="btn btn-primary">Ver detalhes</button></a>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        </div>
        ...
        <div class="">
          <div class="info-box">
            <span class="info-box-icon bg-green"><i class="fa fa-graduation-cap" aria-hidden="true"></i></span>
             <?php  
             $curso=0;
            ...
            <div class="info-box-content">
             ...
             <a style="float: right;" href="relatorio_curso.php"><button class="btn btn-primary">Ver detalhes</button></a>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        </div>
        <div class="info-box">
                  <span style="background: #7B68EE" class="info-box-icon bg-success"><i style="color: white" class="fa fa-file-text" aria-hidden="true"></i></span>
                   <?php  
                   $turma=0;
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo $turma;  ?></span>
                  </div>
                   <a style="float: right;" href="relatorio_turma.php"><button class="btn btn-primary">Ver detalhes</button></a>
                  <!-- /.info-box-content -->
                </div>
        <!-- /.col -->
        <div style="" class="">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php  echo $disciplinas?></span>
            </div>
             <a style="float: right;" href="relatorio_disciplina.php"><button class="btn btn-primary">Ver detalhes</button></a>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <!-- /.col -->
                  ...
                  <div class="info-box">
                  <span style="background: #9ACD32" class="info-box-icon bg-secondary"> <i style="color: white" class="fa fa-list-alt"></i></span>
                   <?php  
                   $noticias=0;
                  ...
                  <div class="info-box-content">
                   ...
                   <a style="float: right;" href="relatorio_noticia.php"><button class="btn btn-primary">Ver detalhes</button></a>
                  <!-- /.info-box-content -->
                </div>
                  <!-- /.progress-group -->
