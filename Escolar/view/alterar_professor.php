...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <i style="font-size: 80px" class="fa fa-address-book-o" aria-hidden="true"><small style="font-size: 60px">
        Alterar Professor
      ...
      <br>
       <?php 
        ...
        $result = $conn -> query("SELECT id, nome, formacao, cpf, email, telefone FROM professor WHERE id = '$id'");
      ...
      <form method="post" action="../model/update_professor.php">
        <div class="form-group">
          <input type="hidden" name="id" value="<?php echo $row -> id?>">
          <label style="font-size: 20px" for="exampleInputEmail1">Nome*</label>
          <input style="width: 50%; font-size: 20px" type="text" class="form-control" name="nome" placeholder="Nome" value="<?php echo $row -> nome ?>">
          
        </div>
        <div class="form-group">

          <label style="font-size: 20px" for="exampleInputEmail1">CPF*</label>
          <input style="width: 50%; font-size: 20px" type="text" maxlength="11" class="form-control" name="cpf" placeholder="CPF" value="<?php echo $row -> cpf ?>">
          
        </div>
        <div class="form-group">

          <label style="font-size: 20px" for="exampleInputEmail1">Formação*</label>
          <input style="width: 50%; font-size: 20px" type="text" class="form-control" name="formacao" placeholder="Formação" value="<?php echo $row -> formacao ?>">
        ...
        <button style="width: 50% ; font-size: 20px" type="submit" onclick="return confirm('Deseja Alterar o Professor')" class="btn btn-primary">Alterar</button>
      </form>
