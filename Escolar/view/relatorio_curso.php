...
<head>
  ...
  <title>Relatorio de Curso</title>
...
<div class="wrapper">
        ...
        if(isset($_GET['resut'])){
          ...
          if(isset($_GET['re'])){
            ...
            echo '<div style="width: 70%; padding: 6px; font-size: 20px; margin-top: 10px" class="alert alert-danger" role="alert">
                Error! Já exite um curso com esse nome!
                </div>';
          }
          ?>
          ...
          if ($result) {
            ...
            while($row = $result->fetch(PDO::FETCH_OBJ)){
                      ...
                      echo  '<tr class="tr2">
                             ...
                             <td><h3 style="margin-left: 5px;"><a href="alterar_curso.php?id='.$row -> id.'"><button title="Alterar" style="font-size: 30px; margin-top: -15px" onclick="return confirm('."'Deseja Alterar o Curso? '".')" type="submit" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></h3></td>
                             <td><h3 style="margin-left: 5px;"><a href="../model/deletar_curso.php?id='.$row -> id.'"><button title="Excluir" style="font-size: 30px; margin-top: -15px" onclick="return confirm('."'Deseja deletar o Curso? '".')" type="submit" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></a></h3></td>
                          </tr>';
                          $cont++;
  ...
  <?php 
  if($cont==0){
          echo '<p style="font-size: 30px">Nenhum Curso foi cadastrado!</p>';
        }
   ?>
    </section>
