...
<head>
  ...
  <title>Painel de Professor</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <br>
        ...
        <div  >
          <!-- small box -->
          <div style="background: #87CEEB" class="small-box bg-info">
            <div class="inner">
              <h3 class="h3">Boletins</h3>
            ...
            <div class="icon">
              <i style="color: black" class="fa fa-table"></i>
            </div>
            <a style="color: black" href="boletim.php" class="small-box-footer">Mais informações <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div  >
          <!-- small box -->
          <div style="background: #A9A9A9" class="small-box bg-dark">
            <div class="inner">
              <h3 class="h3">Frequencias</h3>
            ...
            <a style="color: black" href="frequencia.php" class="small-box-footer">Mais informações <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>

         <div >
          <!-- small box -->
          <div style="background: #90EE90" class="small-box bg-success">
            <div class="inner">
              <h3 class="h3">Afazeres</h3>
            ...
            <div class="icon">
              <i id="i" style="color: black" class="fa fa-list-ul"></i>
            </div>
            <a style="color: black" href="../view/relatorio_afazer.php" class="small-box-footer">Mais informações <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>

        <div >
          <!-- small box -->
          <div  style="background: #FFA07A" class="small-box bg-danger">
            <div class="inner">
            ...
            <a id="a" style="color: black" href="../view/relatorio_noticias.php" class="small-box-footer">Mais informações <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        </div>
